 ...
 *
 * Built on 2023-10-14 at 20:57 UTC
 */
...
extension AppLocaleExtensions on AppLocale {
  ...
  TranslationsEn build() {
    switch (this) {
      ...
      case AppLocale.de:
        return TranslationsDe.build();
      case AppLocale.es:
        return TranslationsEs.build();
      case AppLocale.fr:
        return TranslationsFr.build();
      case AppLocale.ful:
        return TranslationsFul.build();
    }
  }
  ...
  Locale get flutterLocale {
    switch (this) {
      ...
      case AppLocale.ful:
        return const Locale.fromSubtags(languageCode: 'ful');
    }
  }
}
...
class TranslationsDe extends TranslationsEn {
  /// You can call this constructor and build your own translation instance of this locale.
  /// Constructing via the enum [AppLocale.build] is preferred.
  TranslationsDe.build() : super.build();
...
class TranslationsEs extends TranslationsEn {
  /// You can call this constructor and build your own translation instance of this locale.
  /// Constructing via the enum [AppLocale.build] is preferred.
  TranslationsEs.build() : super.build();
...
class TranslationsFr extends TranslationsEn {
  /// You can call this constructor and build your own translation instance of this locale.
  /// Constructing via the enum [AppLocale.build] is preferred.
  TranslationsFr.build() : super.build();
...
class TranslationsFul extends TranslationsEn {
  /// You can call this constructor and build your own translation instance of this locale.
  /// Constructing via the enum [AppLocale.build] is preferred.
  TranslationsFul.build() : super.build();

  @override
  late final TranslationsFul _root = this; // ignore: unused_field
